// Prompt: Have the function ThirdGreatest(strArr) take the array of strings stored in strArr and return the third largest word within in.
...
const thirdGreatest = (strArr) => {
  let newSortedStr = strArr.sort((a, b) => {
    return b.length - a.length
  })
  return newSortedStr[2]
}

console.log(thirdGreatest(str))
